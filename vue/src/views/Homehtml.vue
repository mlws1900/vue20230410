<template>
  <div>
    ...
    <header id="header" class="skel-layers-fixed" style="height: 100px;">
      <h1 style="font-size: 30px;line-height: 100px"><a href="http://localhost:8080/">基于区块链的濒危植物信息系统</a></h1>
...
<!--      <h2 style="color: #eeeeee">濒危植物管理系统</h2>-->
      <div>
        <el-carousel height="400px">
          <el-carousel-item  v-for="item in dataList" :key="item.id" align="center" :row-style="{height:'30px'}" style="font-size: 10px">
            <h3><img :src="item.src" alt="" style="height:400px;"  /></h3>
          </el-carousel-item>
        </el-carousel>
      </div>
...
<!--      </div>-->
    ...
    <section id="one" style="text-align: center;margin-top: 20px">
      <div class="inner" style="position: relative;">
        <b style="font-size: large">输入植物中文名称查询信息</b>
        <ul class="actions">
          <el-input  size="medium" style="width: 500px;" placeholder="请输入植物中文名称" v-model="name" ></el-input>
          <el-button style="margin-left: 10px" type="primary" @click="getone" >查看</el-button>
        </ul>
      </div>
      ...
      <div style="height: 380px;width: 1400px;margin: auto;color: #3f5efb">
        ...
        <el-table  ref="wgzp" :data="tableData" height="380px"  border @cell-mouse-enter="MouseEnter" @cell-mouse-leave="MouseLeave" @row-click="handle" style="font-size: 18px" :row-style="{height:'60px'}">
          ...
          <el-table-column prop="name" label="植物中文名称" width="400">
          </el-table-column>
          <el-table-column prop="name" label="植物拉丁名称" width="400">
          </el-table-column>
          <el-table-column prop="type" label="科名">
          </el-table-column>
          <el-table-column prop="uploadtime" label="保护级别">
          </el-table-column>
        </el-table>
      </div>
    </section>
        ...
        <div class="c1" style="margin-right: 100px;">
          <div>
            <section class="special">
              <a href="http://localhost:8080/login" ><img src="../assets/g/1.png" alt="" class="p" ></a>
              <h3>植物登记</h3>
            </section>
          </div>
        </div>
...
<!--          <div>-->
<!--            <section class="special">-->
<!--              <a href="http://localhost:8080/login" ><img src="../assets/g/2.png" alt="" class="p" ></a>-->
<!--              <h3>转让</h3>-->
<!--            </section>-->
<!--          </div>-->
<!--        </div>-->
...
<!--          <div>-->
<!--            <section class="special">-->
<!--              <a href="http://localhost:8080/login" ><img src="../assets/g/updatat.png" alt="" class="p" ></a>-->
<!--              <h3>修改</h3>-->
<!--            </section>-->
<!--          </div>-->
<!--        </div>-->
        <div class="c1" style="margin-right: 100px;">
          <div>
            <section class="special">
              <a href="http://localhost:8080/login" ><img src="../assets/g/3.png" alt="" class="p" ></a>
              <h3>植物信息</h3>
            </section>
          </div>
        </div>
        <div class="c1" style="margin-right: 100px;">
          <div>
            <section class="special">
              <a href="http://localhost:8080/login" ><img src="../assets/g/4.png" alt="" class="p" ></a>
              <h3>植物查询</h3>
            </section>
          </div>
        </div>
        <div class="c1" style="margin-right: 100px;">
          <div>
            <section class="special">
              <a href="http://localhost:8080/login" ><img src="../assets/g/5.png" alt="" class="p" ></a>
              <h3>数据恢复</h3>
            </section>
          </div>
        </div>
...
<!--          <div>-->
<!--            <el-button type="primary" style="width: 300px;height: 50px;font-size: 30px" @click="xianshi">文化宣传</el-button>-->
...
<!--        <div style="display: inline-block" class="qubie">-->
<!--          <div>-->
<!--            <el-button type="primary" style="width: 300px;height: 50px;font-size: 30px" @click="xianshi1">工艺品展示</el-button>-->
<!--            <p :class="one1" style="font-size: 20px;width: 310px;text-align: left;text-indent: 2em;margin-top: 20px">本平台调研了大量的工艺品资料，并采集了大量的工艺品图片与介绍，放在系统中进行展示，展示的所有数据均真实存在。</p>-->
<!--          </div>-->
<!--        </div>-->
...
<!--            <p :class="one2" style="font-size: 20px;width: 310px;text-align: left;text-indent: 2em;margin-top: 20px">本平台以工艺品信息的安全存储与加密为核心，采用多种技术相结合，保障电子数据的安全存储与共享。</p>-->
<!--          </div>-->
<!--        </div>-->
