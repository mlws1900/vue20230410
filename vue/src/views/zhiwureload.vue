  ...
  <div>
    ...
    <el-dialog title="信息" :visible.sync="dialogFormVisible1">
      <el-form label-width="120px" size="small">
        ...
        <el-form-item label="植物识别码">
          <el-input v-model="form.ucid" autocomplete="off" :disabled="true"></el-input>
        </el-form-item>
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button @click="shensu" :disabled="disabled">数据恢复</el-button>
      </div>
    </el-dialog>
...
export default {
  ...
  methods: {
    ...
    shensu() {
      ...
      this.request.get("http://localhost:9091/banquan/download?ucid=" + this.form.ucid).then(res => {
        if(res) {
          this.$message.success("植物数据恢复成功")
          this.dialogFormVisible1 = false
          this.load()
        }else {
          this.$message.error("植物数据恢复失败")
        }
      })
    },
  }
